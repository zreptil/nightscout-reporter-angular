...
if (isset($_REQUEST['activate'])) {
  ...
  <html>
  <head>
    <title>Nightscout Reporter Themeserver</title>
    <style>
      body {
        margin: 0;
        padding: 0;
        ...
        background: #a0a0ff;
        font-family: roboto, tahoma, verdana, arial, serif;
        font-size: 3em;
        width: 100vw;
        height: 100vh;
      }
...
function mayOverwrite($theme)
{
  ...
  return $body['auth'] == $theme['create_user'] || $isAdmin;
}
