...
export class ThemeData {
  ...
  static colorData: any = {
    ...
    glucLow: {title: $localize`Niedrig`},
    glucNormLow: {title: $localize`Normal Niedrig`},
    glucNorm: {title: $localize`Normal`},
    glucNormHigh: {title: $localize`Normal Hoch`},
    glucHigh: {title: $localize`Hoch`},
