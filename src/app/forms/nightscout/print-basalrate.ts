...
export class PrintBasalrate extends BasePrint {
...
Es gibt aber eine Option, welche nur die letzte Basalrate des Zeitraums ausgibt.`;
  ...
  override params = [
    new ParamInfo(0, PrintBasalrate.msgParam1, {boolValue: true, thumbValue: false}),
  ];
  ...
  static get msgParam1(): string {
    return $localize`Parameter für PrintBasalrate`;
  }

  override get title(): string {
    return $localize`PrintBasalrate`;
  }
