...
export class ThemeService {
  ...
  colorNames: any = {
    ...
    datepickerBtnEmpty: $localize`BtnEmptyBack`,
    datepickerHeadEmpty: $localize`HeadEmptyBack`,
    datepickerHead: $localize`Titel`,
    datepickerBody: $localize`Inhalt`,
    datepickerMonthTitle: $localize`MonthTitleBack`,
    datepickerMonth: $localize`MonthBack`,
    datepickerBtnRaised: $localize`BtnRaisedBack`,
    datepickerBtnRaisedKey: $localize`BtnRaisedKeyBack`,
    datepickerBtnShiftKey: $localize`BtnShiftKeyBack`,
    datepickerDowActive: $localize`DowActiveBack`,
    datepickerDowInactive: $localize`DowInactiveBack`,
    ...
    logDebugColor: $localize`DebugColor`,
    logDebug: $localize`DebugFore`,
